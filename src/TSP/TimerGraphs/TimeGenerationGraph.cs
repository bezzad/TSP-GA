...
namespace TSP.TimerGraphs
{
    public partial class TimeGenerationGraph : Form
    {
        ...
        public TimeGenerationGraph()
        {
            ...
            myPane.Title.Text = "TSP Time-Generation Chart Line";
            myPane.XAxis.Title.Text = "Time (Graph timer at the moment per millisecond)";
            myPane.YAxis.Title.Text = "Generation (Number reproduction of population)";
        }
